...
if page =="Data Analysis":
    ...
    with st.form("Customer Details"):
        ...
        Purchases = st.sidebar.number_input(label ='Total Purchases',step=(5))
        day_engaged = st.sidebar.number_input(label ='Number of Days with Company',step=(50))
        ...
        Customer_Segment_Gen_X	 =  st.sidebar.selectbox('GenX (43 - 58 years old)	', ('0','1'))
        Customer_Segment_Boomer =  st.sidebar.selectbox('Boomer (59 - 77 years old)' , ('0','1'))
        Customer_Segment_Silent =  st.sidebar.selectbox('Silent (78 - 95 years old)', ('0','1'))
